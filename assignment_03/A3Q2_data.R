...
##################################################
#
# A3Q2_data is an exercise in joining
...
# wd_path <- "~/Teaching/QMB6358_Fall_2023/Assignments/assignment_03"
