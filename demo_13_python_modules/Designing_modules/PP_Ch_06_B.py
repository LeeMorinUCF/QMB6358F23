...
# You can access the help for your functions
# from the docstrings.
help(temperature.convert_to_celsius)
 

# For a list of the functions in the module. 
help(temperature)
...
# Note that there is no variable called 'x' only.
print(x)
...
# Another example with numpy.
import numpy as np

print("After import, __name__ is", __name__, 
	"and np.__name__ is", np.__name__)
