...
# Be sure that this library is located in the same folder.
...
print(var_x(x = c(1, 1, 1)))
# Test output against expected answer.
print(var_x(x = c(1, 1, 1)) == 0) # Zero is the answer that I expect.
...
# Check values that are output.
print(covar_y_x(y = c(0, 0, 0), x = c(1, 1, 1)))
# Test output against expected answer.
print(covar_y_x(y = c(0, 0, 0), x = c(1, 1, 1)) == 0)
...
# Check values that are output.
print(slope_y_x(y = c(0, 0, 0), x = c(-1, 0, 1)))
# Test output against expected answer.
print(slope_y_x(y = c(0, 0, 0), x = c(-1, 0, 1)) == 0)
...
# Did all your examples print TRUE?
